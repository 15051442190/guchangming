...
<TABLE class=house-list>
  ...
  <TR>
    ...
    <TD class=house-price><LABEL class=ui-green><INPUT value="删    除" onclick="location.href='deletHouse?id=${h.id}';" type=button name=search></LABEL></TD>
  </TR>
  </c:forEach>
  </TBODY></TABLE></DIV>
<DIV class=pager>
<UL>
  ...
  href="getHouseByUserid?page=${num}"
